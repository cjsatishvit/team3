...
<%@page import="repossessions.Read_Values"%><%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <div align ="center" style="width:450px; height:300px; background: mistyrose;border-radius: 40px;">
    ...
    try
    {
        ...
        Connection con=(Connection)DriverManager.getConnection(
            "jdbc:mysql://localhost:3306/defaulter","root","");
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("select * from defaulters.DEFAULTERLIST;");
