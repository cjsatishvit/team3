...
public class Insert_NoticeValues {
	public void insert_noticevalues(String FirstName,String LastName,String LoanId, String  DefaulterId)
	{
		 DB_Connection2 obj_DB_Connection2=new DB_Connection2();
		 Connection connection=obj_DB_Connection2.get_connection();
		 PreparedStatement ps=null;
		try {
	String query="insert into defaulters.foreclosuresnotice(FirstName,LastName,LoanId,DefaulterId) values(?,?,?,?)";
